              ...
              {isEditing ? (
                ...
                <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-2 gap-4 max-w-2xl text-xs">
                    <div className="bg-secondary/20 border border-border/50 p-4 rounded-xl space-y-1.5">
                  ...
                  <div className="border border-border rounded-xl overflow-hidden max-w-2xl bg-secondary/10">
                    <div className="bg-secondary/30 border-b border-border px-4 py-3 flex items-center justify-between text-xs">
